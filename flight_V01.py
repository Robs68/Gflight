...
print ("lancement du script python : " +name_of_bdd)
...
cursor.execute('CREATE TABLE IF NOT EXISTS '+name_of_bdd+' (id integer PRIMARY KEY, heure_recherche TEXT, trajet1 TEXT, trajet2 TEXT, trajet3 NULL, heure_depart TEXT, duree INTEGER, prix INTEGER);')
cursor.executemany('INSERT INTO '+name_of_bdd+' (heure_recherche,trajet1, trajet2, trajet3, heure_depart, duree, prix) values (?,?,?,?,?,?,?)',(vol_1,))
